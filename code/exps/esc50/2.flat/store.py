...
#PATTERN:exp_mode_dataset_metrics_attempt.csv
def define_filenames_pattern(expid, mode, vfold, attempt):
  
  #ovr_results_filename =exp+'_'+mode+'_'+dataset+'_'+metrics+'_'+attempt+'.xlsx'
  #classf1_report_filename = exp+'_'+mode+'_'+dataset+'_'+'class_f1_report'+attempt+'.xlsx'
