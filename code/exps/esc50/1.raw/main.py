...
#define mode
mode_instance = mode_class(44100)
...
#load waveforms
print('loadin waveforms..')
train_data = data.ESC50Data(train_data, 'filename', 'category', audio_path, mode)
valid_data = data.ESC50Data(valid_data, 'filename', 'category', audio_path, mode)
...
#model = models.ap1d_cnn2(batch_size=16, num_cats=50).to(device)
#modelid='ap1d_cnn2'
