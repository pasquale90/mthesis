...
def save_genres(micro, macro, validation_fold, filename):
  ...
  if os.path.isfile(path+filename):
    ...
    data = {validation_fold : [micro,macro]}
    general_results = pd.DataFrame(data=data, index=['micro_f1','macro_f1'], dtype=np.float16)
