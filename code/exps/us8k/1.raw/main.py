...
#define mode
mode_instance = mode_class(44100)#22050
...
train_data = data.US8KData(train_data, 'slice_file_name', 'Class', audio_path, folds, mode)
valid_data = data.US8KData(valid_data, 'slice_file_name', 'Class', audio_path, folds, mode)
